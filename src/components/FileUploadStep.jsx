...
export default function FileUploadStep({
  ...
  return (
    <div>
      ...
      {(uploadImage.imageUrl || editValues?.imageUrl) && (
        <div className="mt-4">
          <img
            src={editValues?.imageUrl || uploadImage?.imageUrl || null}
      ...
      <div className="mt-8 flex item-center justify-between">
        ...
        <Button
          ...
          label={uploadImage.status === 200 ? "Submit" : "Upload"}
          type="submit"
          style="primary"
          disabled={!uploadImage.imageUrl || editValues?.imageUrl}
        />
      </div>
    </div>
  );
